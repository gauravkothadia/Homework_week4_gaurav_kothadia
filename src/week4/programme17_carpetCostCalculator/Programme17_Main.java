 ...
 */
public class Programme17_Main {
    public static void main(String[] args) {
        Programme17_Carpet carpet = new Programme17_Carpet(3.5);
        Programme17_Floor floor = new Programme17_Floor(2.75, 4.0);
        Programme17_Calculator calculator = new Programme17_Calculator(floor, carpet);
        System.out.println("total= " + calculator.getTotalCost());
        carpet = new Programme17_Carpet(1.5);
        floor = new Programme17_Floor(5.4, 4.5);
        calculator = new Programme17_Calculator(floor, carpet);
        System.out.println("total= " + calculator.getTotalCost());
    }
}
